...
namespace Mvc_PDF.Controllers
{
    public class AlunoesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "alunoID,Nome,Classe,Nascimento,Email")] Aluno aluno)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "alunoID,Nome,Classe,Nascimento,Email")] Aluno aluno)
        {
            if (ModelState.IsValid)
            {
